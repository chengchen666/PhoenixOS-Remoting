...
pub struct EmulatorChannel {
    ...
    last_timestamp: Arc<Mutex<MsTimestamp>>,
    rtt: f64,
    bandwidth: f64,
}
...
impl EmulatorChannel {
    pub fn new(manager: Box<dyn CommChannelInner>) -> Self {
        Self {
            ...
            last_timestamp: Arc::new(Mutex::new(MsTimestamp::new())),
            rtt: CONFIG.rtt,
    ...
    #[inline]
    pub fn get_last_timestamp(&self) -> MsTimestamp {
        *self.last_timestamp.lock().unwrap()
    }

    #[inline]
    pub fn set_last_timestamp(&self, last_timestamp: MsTimestamp) {
