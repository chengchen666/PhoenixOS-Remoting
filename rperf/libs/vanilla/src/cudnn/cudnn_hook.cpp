...
HOOK_C_API HOOK_DECL_EXPORT cudnnStatus_t cudnnSetTensorTransformDescriptor(
    ...
    const int32_t *padBeforeA, const int32_t *padAfterA, const uint32_t *foldA,
    const cudnnFoldingDirection_t direction) {
    HOOK_TRACE_PROFILE("cudnnSetTensorTransformDescriptor");
    using func_ptr =
        cudnnStatus_t (*)(cudnnTensorTransformDescriptor_t, const uint32_t, const cudnnTensorFormat_t, const int32_t *,
                          const int32_t *, const uint32_t *, const cudnnFoldingDirection_t);
...
HOOK_C_API HOOK_DECL_EXPORT cudnnStatus_t cudnnSetConvolutionNdDescriptor(
    cudnnConvolutionDescriptor_t convDesc, int arrayLength, const int *padA, const int *filterStrideA,
    const int *dilationA, cudnnConvolutionMode_t mode, cudnnDataType_t computeType) {
...
HOOK_C_API HOOK_DECL_EXPORT cudnnStatus_t cudnnGetPoolingNdForwardOutputDim(
    const cudnnPoolingDescriptor_t poolingDesc, const cudnnTensorDescriptor_t inputTensorDesc, int nbDims,
...
HOOK_C_API HOOK_DECL_EXPORT cudnnStatus_t
    cudnnGetSeqDataDescriptor(const cudnnSeqDataDescriptor_t seqDataDesc, cudnnDataType_t *dataType, int *nbDims,
...
HOOK_C_API HOOK_DECL_EXPORT cudnnStatus_t cudnnMultiHeadAttnForward(
    ...
    using func_ptr =
        cudnnStatus_t (*)(cudnnHandle_t, const cudnnAttnDescriptor_t, int, const int *, const int *, const int *,
                          const int *, const cudnnSeqDataDescriptor_t, const void *, const void *,
                          const cudnnSeqDataDescriptor_t, const void *, const cudnnSeqDataDescriptor_t, const void *,
                          const cudnnSeqDataDescriptor_t, void *, size_t, const void *, size_t, void *, size_t, void *);
