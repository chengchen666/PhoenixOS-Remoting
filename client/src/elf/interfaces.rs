...
#[test]
fn bindgen_test_layout_fat_header() {
    const UNINIT: ::std::mem::MaybeUninit<fat_header> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<fat_header>(),
        48usize,
        concat!("Size of: ", stringify!(fat_header))
    );
    assert_eq!(
        ::std::mem::align_of::<fat_header>(),
        1usize,
        concat!("Alignment of ", stringify!(fat_header))
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).text2) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(fat_header),
...
extern "C" {
    pub fn elf2_init() -> ::std::os::raw::c_int;
}
extern "C" {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct kernel_info {
    pub name: *mut ::std::os::raw::c_char,
    pub param_size: usize,
    pub param_num: usize,
    pub param_offsets: *mut u16,
    pub param_sizes: *mut u16,
    pub host_fun: *mut ::std::os::raw::c_void,
    pub hh_host_func: UT_hash_handle,
    pub hh_name: UT_hash_handle,
}
#[test]
fn bindgen_test_layout_kernel_info() {
    const UNINIT: ::std::mem::MaybeUninit<kernel_info> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kernel_info>(),
        160usize,
        concat!("Size of: ", stringify!(kernel_info))
    );
    assert_eq!(
        ::std::mem::align_of::<kernel_info>(),
        8usize,
        concat!("Alignment of ", stringify!(kernel_info))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(kernel_info),
            "::",
            stringify!(name)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).param_size) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(kernel_info),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).param_offsets) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(kernel_info),
            "::",
            stringify!(param_offsets)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).param_sizes) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(kernel_info),
            "::",
            stringify!(param_sizes)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).host_fun) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(kernel_info),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).hh_host_func) as usize - ptr as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(kernel_info),
            "::",
            stringify!(hh_host_func)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).hh_name) as usize - ptr as usize },
        104usize,
        concat!(
            "Offset of field: ",
            stringify!(kernel_info),
...
pub type kernel_info_t = kernel_info;
extern "C" {
